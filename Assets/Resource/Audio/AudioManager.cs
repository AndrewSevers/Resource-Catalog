...
namespace Resource {
    ...
    public class AudioManager : Singleton<AudioManager> {
        ...
        public void Initialize(float aMusicVolume = 1.0f, float aSoundEffectsVolume = 1.0f) {
            if (initialized == false) {
                ...
                for (int i = 0; i < musicTracks.Length; i++) {
                    clips[musicTracks[i].name] = musicTracks[i];
                }

                for (int i = 0; i < soundEffects.Length; i++) {
                    clips[soundEffects[i].name] = soundEffects[i];
                }
        ...
        public void FadeIn(float aFadeDuration) {
            // TODO: FILL IN
        }

        public void FadeOut(float aFadeDuration) {
            // TODO: FILL IN
        }
